...
class LibSVMDataset(Dataset):
    ...
    def __init__(self, X, y, query_ids, transform=None):
        ...
        """
        X = X.toarray()
        #query_ids = np.random.choice(query_ids, int(len(query_ids) * 0.8))
...
def load_libsvm_dataset_ab(input_path: str, slate_length: int, validation_ds_role: str) \
...
def create_data_loaders_ab(train_ds: LibSVMDataset, val_ds: LibSVMDataset, num_workers: int, batch_size: int):
    """
